...
class RecommendationController extends Controller
{
    ...
    public function trainingReport()
    {
        ...
        $mf = new MatrixFactorizationService();
        $mf->recommendGroups($user->UserID, 4); // running this populates $mf->lossHistory

        $lossHistory = $mf->lossHistory;

        return view('recommendations.training', compact('lossHistory'));
    }
}